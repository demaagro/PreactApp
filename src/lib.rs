...
#[derive(Debug)]
pub struct PreactAppProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PreactAppProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PreactApp processing");
    
    let mut processor = PreactAppProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PreactAppProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PreactAppProcessor::new(false);
